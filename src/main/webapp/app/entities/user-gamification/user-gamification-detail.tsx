    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/user-gamification" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/user-gamification/${userGamificationEntity.id}/edit`} replace color="primary">
